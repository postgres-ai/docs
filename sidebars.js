  ...
  baseSidebar: {
    ...
    "Monitoring": [
      "monitoring/index",
      {
        ...
        items: [
          "monitoring/getting-started/index",
          "monitoring/getting-started/requirements",
          "monitoring/getting-started/installation-cli",
      ...
      },
      {
        ...
        items: [
          ...
          "monitoring/dashboards/node-overview",
          "monitoring/dashboards/query-analysis",
          "monitoring/dashboards/single-query",
          "monitoring/dashboards/wait-events",
          "monitoring/dashboards/backups",
          "monitoring/dashboards/replication",
          "monitoring/dashboards/autovacuum",
          "monitoring/dashboards/table-stats",
          "monitoring/dashboards/single-table",
          "monitoring/dashboards/index-health",
          "monitoring/dashboards/single-index",
          "monitoring/dashboards/slru",
          "monitoring/dashboards/lock-contention",
          "monitoring/dashboards/io-statistics",
          "monitoring/dashboards/self-monitoring",
        ],
      },
      {
        type: "category",
        ...
        items: [
          ...
          "monitoring/metrics/pg-stat-statements",
          "monitoring/metrics/wait-events",
          "monitoring/metrics/table-metrics",
          "monitoring/metrics/index-metrics",
      ...
      },
      {
        ...
        label: "Configuration",
        items: [
          "monitoring/configuration/index",
          "monitoring/configuration/pgwatch-config",
          "monitoring/configuration/prometheus-config",
          "monitoring/configuration/grafana-config",
      ...
      },
      {
        ...
        items: [
          "monitoring/troubleshooting/index",
          "monitoring/troubleshooting/no-data",
          "monitoring/troubleshooting/permissions",
      ...
      },
      {
        ...
        label: "Advanced",
        items: [
          "monitoring/advanced/index",
          "monitoring/advanced/multi-cluster",
          "monitoring/advanced/architecture",
