...
## Guides
- [Install DBLab Engine from Postgres AI Console](/docs/how-to-guides/administration/install-dle-from-postgres-ai)
- [Install DBLab Engine from AWS Marketplace](/docs/how-to-guides/administration/install-dle-from-aws-marketplace)
- [Install DBLab Engine manually](/docs/how-to-guides/administration/install-dle-manually)
