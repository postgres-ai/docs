...
See config examples [here](https://gitlab.com/postgres-ai/database-lab/-/tree/v4.1.1/engine/configs)
:::
...
If you want to see more details, enable debug mode setting option `debug` to `true` (see [example](https://gitlab.com/postgres-ai/database-lab/-/tree/v4.1.1/engine/configs)). Next, follow  [the reconfiguration guidelines](#reconfigure-dblab-engine) to apply the change.
