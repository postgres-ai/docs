...
> The protected clone could not be deleted automatically or manually. In order to delete the clone, you would need to [unprotect it](/docs/guides/clone_protection).
