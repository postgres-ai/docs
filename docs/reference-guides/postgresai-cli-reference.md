...
- `--supabase-access-token <token>` — Supabase Management API token (or `SUPABASE_ACCESS_TOKEN` env var). Tokens can be created at <https://supabase.com/dashboard/account/tokens>.
