---
title: PostgresAI Assistant (beta) tools
sidebar_label: PostgresAI Assistant tools
---

import { KBStatsMarkdown } from '@site/src/components/KBStats/KBStatsMarkdown'
...
| **Parameter** | **Type**  | **Description**   | **Default** | **Example** |
| --- |--- | ---- | --- | --- |
| **CLOUD_PROVIDER**              | `string`  | The Cloud provider for server creation. Available options: 'aws', 'gcp', 'azure', 'digitalocean', 'hetzner'. | `"hetzner"`                                       | `"hetzner"`                               |
| **SERVER_TYPE** (required)      | `string`  | Type of server to deploy. Available values: 'CCX13' (2 vCPUs, 8 GB RAM), 'CCX23' (4 vCPUs, 16 GB RAM), 'CCX33' (8 vCPUs, 32 GB RAM), 'CCX43' (16 vCPUs, 64 GB RAM), 'CCX53' (32 vCPUs, 128 GB RAM), 'CCX63' (48 vCPUs, 192 GB RAM). | `"CCX13"`                                       | `"CCX13"`                               |
| **SERVER_LOCATION**             | `string`  | Hetzner region for server deployment. | `"ash"`                                                    | `"ash"`                                 |
| **SERVERS_COUNT**               | `string`  | Number of Postgres VMs in cluster.                                                              | `"1"`                                                   | `"2"`                                           |
| **SERVER_IMAGE**                | `string`  | OS.                                         | `"ubuntu-24.04"` | `"ubuntu-24.04"` |
...
| **PGBOUNCER**                   | `boolean`  | Use PgBouncer or not.                                                                           | `"false"`                                               | `"true"`                                        |
| **PGBOUNCER_COUNT**             | `string`  | Number of PgBouncers to be installed (with `SO_REUSEPORT`).                                       | `"1"`                                                   | `"2"`                                           |
| **HAPROXY**              | `boolean`  | Use HAProxy or not.                                                                             | `"false"`                                               | `"true"`                                        |
| **PG_STAT_KCACHE**              | `boolean`  | Install pg_stat_kcache extension or not.                                                        | `"true"`                                               | `"true"`                                        |
| **PG_WAIT_SAMPLING**            | `boolean`  | Install pg_wait_sampling extension or not.                                                      | `"true"`                                               | `"true"`                                        |
| **POSTGRES_VERSION** (required) | `string`  | Postgres major version. Options: `10`, `11`, `12`, `13`, `14`, `15`, `16`, `17`.                | `"17"`                                                  | `"15"`                                          |
