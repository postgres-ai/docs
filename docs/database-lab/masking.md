...
![Pre-masking / Option 1b. Anonymized dump using additional DBLab Engine](/assets/masking-1b-dump-add.png)
...
![Post-masking / Option 2a. DBLab Engine on production](/assets/masking-2a-production.png)
