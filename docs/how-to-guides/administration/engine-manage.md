...
See config examples [here](https://gitlab.com/postgres-ai/database-lab/-/tree/v4.0.0-rc.4/engine/configs)
:::
...
If you want to see more details, enable debug mode setting option `debug` to `true` (see [example](https://gitlab.com/postgres-ai/database-lab/-/tree/v4.0.0-rc.4/engine/configs)). Next, follow  [the reconfiguration guidelines](#reconfigure-database-lab) to apply the change.
