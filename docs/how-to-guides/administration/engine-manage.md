...
See config examples [here](https://gitlab.com/postgres-ai/database-lab/-/blob/v3.0.1/configs/)
:::
...
If you want to see more details, enable debug mode setting option `debug` to `true` (see [example](https://gitlab.com/postgres-ai/database-lab/-/blob/v3.0.1/configs/)). Next, follow  [the reconfiguration guidelines](#reconfigure-database-lab) to apply the change.
