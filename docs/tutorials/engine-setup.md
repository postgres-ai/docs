---
title: Start using Database Lab
sidebar_label: Start using Database Lab
---
> For AWS RDS see the [How to setup Database Lab Engine with AWS RDS](/docs/tutorials/engine-setup-rds).
...
with two disks, one is for the system and one is for the database.
...
1. prepare a machine with two disks, Docker and copy-on-write file system (this tutorial covers both ZFS and LVM modes),
...
## Step 1. Prepare a machine with two disks, Docker and copy-on-write file system
...
Setup copy-on-write file system:
