---
title: >-
  How to estimate the YoY growth of a very large table using row creation
  timestamps and the planner statistics
sidebar_label: >-
  estimate the YoY growth of a very large table using row creation timestamps
  and the planner statistics
description: ''
keywords:
  - postgresql
  - estimate
