---
title: >-
  Postgres major upgrade without any downtime for a very large cluster running
  under heavy load
sidebar_label: >-
  PG major upgrade without any downtime for a very large cluster running under
  heavy load
description: ''
keywords:
  - postgresql
