...
slug: how-to-add-a-check-constraint-without-downtime
sidebar_label: add a CHECK constraint without downtime
description: ""
keywords: ["postgresql","check","constraint","without","downtime","intermediate"]
tags: ["intermediate", "constraints", "check-constraints", "zero-downtime", "ddl", "validation"]
