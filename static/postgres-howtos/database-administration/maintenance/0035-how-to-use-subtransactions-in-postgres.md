...
slug: how-to-use-subtransactions-in-postgres
sidebar_label: use subtransactions in PG
description: >-
  Understand subtransactions, savepoints, and their impact on database
  performance
keywords:
  - postgresql
  - subtransactions
...
![Rolled-back subtransaction example](/img/postgres-howtos/0035_rolled_back_subtransaction_example.jpg)
...
![Performance drop for more than 64 subtransactions in a transaction](/img/postgres-howtos/0035_performance_drop_too_many_subtx.jpg)

...or this:

![Performance drop of standby server with primary running a long transaction and many subtransactions](/img/postgres-howtos/0035_standby_server_killed.jpg)
