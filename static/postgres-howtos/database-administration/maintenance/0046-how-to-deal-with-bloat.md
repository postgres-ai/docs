---
title: How to deal with bloat
slug: how-to-deal-with-bloat
sidebar_label: deal with bloat
description: >-
  Detect, measure, and eliminate table and index bloat to maintain database
  health
keywords:
  - postgresql
  - deal
...
* You can monitor the progress of reindexing using the approach
  from [How to monitor CREATE INDEX / REINDEX](/docs/postgres-howtos/performance-optimization/indexing/how-to-monitor-index-operations).
