...
slug: how-to-enable-data-checksums-without-downtime
sidebar_label: enable data checksums without downtime
description: ""
keywords: ["postgresql","enable","data","checksums","without","downtime","beginner"]
tags: ["beginner", "data-integrity", "checksums", "corruption", "zero-downtime", "reliability"]
difficulty: beginner
...
`pg_checksums` doesn't check it when running (it does it only in the very beginning). There is a good trick to avoid
