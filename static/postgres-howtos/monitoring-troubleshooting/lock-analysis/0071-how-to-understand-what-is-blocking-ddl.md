---
title: How to understand what's blocking DDL
slug: how-to-understand-what-is-blocking-ddl
sidebar_label: understand what's blocking DDL
description: ""
keywords: ["postgresql","understand","what's","blocking","intermediate"]
tags: ["intermediate", "locking", "troubleshooting", "ddl", "concurrency", "diagnostics"]
difficulty: intermediate
estimated_time: 5 min
---


In [day 60](/docs/postgres-howtos/schema-design/ddl-operations/how-to-add-a-column), we discussed how to add a column and that under load you need
