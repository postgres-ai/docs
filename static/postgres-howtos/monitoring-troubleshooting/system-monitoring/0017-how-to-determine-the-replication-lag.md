---
title: How to determine the replication lag
slug: how-to-determine-the-replication-lag
sidebar_label: determine the replication lag
description: ""
keywords: ["postgresql","determine","replication","intermediate"]
tags: ["intermediate", "replication", "monitoring", "lag", "streaming", "diagnostics"]
...
The lag can be observed from the primary (in the context of logical replication, it's usually called "publisher").
