---
title: How to NOT get screwed as a DBA (DBRE)
slug: how-to-not-get-screwed-as-a-dba
sidebar_label: NOT get screwed as a DBA (DBRE)
description: ""
keywords: ["postgresql","screwed","(dbre)","beginner"]
tags: ["beginner", "dba", "best-practices", "backup", "administration", "advice"]
difficulty: beginner
...
- If self-managed, use **Patroni**. Otherwise, study all the HA options your provider offers and use them.
...
- Subtransactions – I personally consider their use dangerous in heavily-loaded systems and recommend
  [avoiding them](/docs/postgres-howtos/database-administration/maintenance/how-to-use-subtransactions-in-postgres).
