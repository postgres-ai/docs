...
slug: how-to-flush-caches
sidebar_label: flush caches (OS page cache and PG buffer pool)
description: ""
keywords: ["postgresql","flush","caches","page","cache","postgres","buffer","pool)","intermediate"]
tags: ["intermediate", "caches", "performance", "testing", "buffer-pool", "os-cache"]
