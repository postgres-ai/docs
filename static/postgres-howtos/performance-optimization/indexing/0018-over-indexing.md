...
title: Over-indexing
slug: over-indexing
sidebar_label: Over-indexing
description: ""
keywords: ["postgresql","over-indexing","beginner"]
tags: ["beginner", "indexes", "performance", "hot-updates", "antipatterns", "optimization"]
difficulty: beginner
...
![Degradation of query plan time with increase in number of indexes](/img/postgres-howtos/0018_degradation_with_indexes.png)

Compared to the execution time:

![Mean plan / execution time vs. # indexes](/img/postgres-howtos/0018_plan_exec_time_vs_index.png)
...
![Flame graph](/img/postgres-howtos/0018_flame_graph.png)
