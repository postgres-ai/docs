...
slug: how-to-analyze-heavyweight-locks-part-1
sidebar_label: analyze heavyweight locks, part 1
description: ""
keywords: ["postgresql","analyze","heavyweight","locks,","part","beginner"]
tags: ["beginner", "locking", "concurrency", "locks", "analysis", "troubleshooting"]
difficulty: beginner
...
- Only 16 of the locks have `fastpath=true`. When `fastpath=false`, Postgres lock manager uses a slower, but more
  ...
  [Over-indexing](/docs/postgres-howtos/performance-optimization/indexing/over-indexing).
