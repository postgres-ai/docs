---
title: How to rebuild many indexes using many backends avoiding deadlocks
slug: rebuild-indexes-without-deadlocks
sidebar_label: rebuild many indexes using many backends avoiding deadlocks
description: ""
keywords: ["postgresql","rebuild","many","indexes","using","many","backends","avoiding","deadlocks","intermediate"]
tags: ["intermediate", "indexes", "reindex", "deadlocks", "concurrency", "maintenance"]
