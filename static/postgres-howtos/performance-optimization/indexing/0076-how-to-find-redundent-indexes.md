---
title: How to find redundant indexes
slug: how-to-find-redundent-indexes
sidebar_label: find redundant indexes
description: ""
keywords: ["postgresql","find","redundant","indexes","beginner"]
tags: ["beginner", "indexes", "redundant", "optimization", "cleanup", "maintenance"]
difficulty: beginner
...
The same [6 reasons that we discussed for the unused indexes](/docs/postgres-howtos/performance-optimization/indexing/how-to-find-unused-indexes) are applicable here.
...
3. Optionally, consider the "soft-drop" technique as described
   in [Index maintenance](/docs/postgres-howtos/performance-optimization/indexing/index-maintenance), before actually dropping an index.
