...
description: ""
keywords: ["postgresql","index","maintenance","beginner"]
tags: ["beginner", "indexes", "maintenance", "health-check", "performance", "administration"]
difficulty: beginner
...
How to analyze index bloat: see [How to deal with bloat](/docs/postgres-howtos/database-administration/maintenance/how-to-deal-with-bloat).
