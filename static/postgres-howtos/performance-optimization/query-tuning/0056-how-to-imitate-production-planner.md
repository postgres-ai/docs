---
title: How to make the non-production Postgres planner behave like in production
slug: how-to-imitate-production-planner
sidebar_label: make the non-production PG planner behave like in production
description: ""
keywords: ["postgresql","make","non-production","postgres","planner","behave","like","production","intermediate"]
tags: ["intermediate", "query-planning", "testing", "production", "statistics", "environment"]
