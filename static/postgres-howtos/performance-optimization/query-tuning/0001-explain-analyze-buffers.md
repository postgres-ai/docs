---
title: EXPLAIN ANALYZE or EXPLAIN (ANALYZE, BUFFERS)?
slug: explain-analyze-buffers
sidebar_label: EXPLAIN ANALYZE or EXPLAIN (ANALYZE, BUFFERS)?
description: "UPDATE 2025: Starting with Postgres 18, the `BUFFERS` option becomes default in `EXPLAIN ANALYZE`, which is great news."
keywords: ["postgresql","explain","analyze","explain","(analyze,","buffers)?","intermediate"]
tags: ["intermediate", "explain", "query-analysis", "performance", "buffers", "execution-plans"]
...
If `EXPLAIN ANALYZE` is used without `BUFFERS`, the analysis lacks the information about the buffer pool IO.
