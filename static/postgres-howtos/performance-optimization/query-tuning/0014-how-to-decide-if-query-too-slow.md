---
title: How to decide when a query is too slow and needs optimization
slug: how-to-decide-if-query-too-slow
sidebar_label: decide when a query is too slow and needs optimization
keywords:
  - postgresql
  - decide
  - when
...
<img src="/img/postgres-howtos/0014_cover.png" width="600" />
