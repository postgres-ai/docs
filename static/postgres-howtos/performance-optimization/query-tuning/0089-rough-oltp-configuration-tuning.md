...
slug: rough-oltp-configuration-tuning
sidebar_label: Rough configuration tuning (80/20 rule; OLTP)
description: ""
keywords: ["postgresql","rough","configuration","tuning","(80/20","rule;","oltp)","beginner"]
tags: ["beginner", "configuration", "tuning", "oltp", "performance", "basics"]
difficulty: beginner
