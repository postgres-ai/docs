...
slug: how-to-run-analyze
sidebar_label: run ANALYZE (to collect statistics)
description: Learn how to how to run analyze (to collect statistics)
keywords: ["postgresql","analyze","collect","statistics)","intermediate"]
tags: ["intermediate", "analyze", "statistics", "query-planning", "maintenance", "performance"]
