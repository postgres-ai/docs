...
title: psql tuning
slug: psql-tuning
sidebar_label: psql tuning
description: ""
keywords: ["postgresql","psql","tuning","intermediate"]
tags: ["intermediate", "psql", "productivity", "configuration", "tuning", "optimization"]
...
![psql ugly output](/img/postgres-howtos/0059_psql_ugly_output.png)

After installation:

![pspg improved output](/img/postgres-howtos/0059_pspg_improved_output.png)

![pspg menus](/img/postgres-howtos/0059_pspg_menus.jpg)
...
![postgres_dba menu support](/img/postgres-howtos/0059_postgres_dba.jpg)
