---
title: How to format text output in psql scripts
slug: how-to-format-text-output-in-psql-scripts
sidebar_label: format text output in psql scripts
description: ""
keywords: ["postgresql","format","text","output","psql","scripts","beginner"]
tags: ["beginner", "psql", "scripting", "formatting", "ansi-colors", "output"]
difficulty: beginner
...
![](/img/postgres-howtos/0091_result.png)
...
When `less` is used, formatting doesn't work – but it can be solved with the option `-R`:
