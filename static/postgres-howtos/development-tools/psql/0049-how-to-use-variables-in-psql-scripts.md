---
title: How to use variables in psql scripts
slug: how-to-use-variables-in-psql-scripts
sidebar_label: use variables in psql scripts
description: ""
keywords: ["postgresql","variables","psql","scripts","advanced"]
tags: ["advanced", "psql", "scripting", "variables", "automation", "development"]
difficulty: advanced
...
Note the quite strange syntax – `:'str1'`. It may require some time to memorize.
