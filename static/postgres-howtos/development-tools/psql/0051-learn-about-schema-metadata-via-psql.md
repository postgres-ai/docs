---
title: Learn how to work with schema metadata by spying after psql
slug: learn-about-schema-metadata-via-psql
sidebar_label: Learn to work with schema metadata by spying on psql
description: ""
keywords: ["postgresql","learn","work","with","schema","metadata","spying","after","psql","advanced"]
tags: ["advanced", "psql", "metadata", "schema", "reverse-engineering", "system-catalogs"]
difficulty: advanced
