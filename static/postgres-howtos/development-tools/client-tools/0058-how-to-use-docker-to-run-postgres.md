...
slug: how-to-use-docker-to-run-postgres
sidebar_label: use Docker to run PG
description: ""
keywords: ["postgresql","docker","postgres","beginner"]
tags: ["beginner", "docker", "containers", "development", "testing", "setup"]
difficulty: beginner
...
Running docker in a container for development and testing can help you align the sets of libraries, extensions, software
