---
title: How to set application_name without extra queries
slug: how-to-set-application-name-without-extra-queries
sidebar_label: set application_name without extra queries
description: ""
keywords: ["postgresql","application_name","without","extra","queries","intermediate"]
tags: ["intermediate", "connection", "application_name", "monitoring", "configuration", "identification"]
difficulty: intermediate
estimated_time: 5 min
---


`application_name` is useful to control what you and others are going to see in `pg_stat_activity` (it has a column with
