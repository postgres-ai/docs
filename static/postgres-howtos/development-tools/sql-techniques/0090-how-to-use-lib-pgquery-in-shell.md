---
title: How to use lib_pgquery in shell to normalize and match queries from various sources
slug: how-to-use-lib-pgquery-in-shell
sidebar_label: use lib_pgquery in shell to normalize and match queries from various sources
description: ""
keywords: ["postgresql","lib_pgquery","shell","normalize","match","queries","from","various","sources","beginner"]
tags: ["beginner", "query-analysis", "normalization", "tools", "lib_pgquery", "fingerprint"]
difficulty: beginner
