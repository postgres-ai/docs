---
title: "\"Find-or-insert\" using a single query"
slug: find-or-insert-using-a-single-query
sidebar_label: "\"Find-or-insert\" using a single query"
description: ""
keywords: ["postgresql","\"find-or-insert\"","using","single","query","beginner"]
tags: ["beginner", "sql", "upsert", "find-or-insert", "development", "patterns"]
difficulty: beginner
