---
title: How to format SQL (SQL style guide)
slug: how-to-format-sql
sidebar_label: format SQL (SQL style guide)
description: ""
keywords: ["postgresql","format","(sql","style","guide)","beginner"]
tags: ["beginner", "sql", "style-guide", "formatting", "development", "best-practices"]
difficulty: beginner
estimated_time: 6 min
---


There are various approaches to formatting SQL. There are two major ones:
