---
title: How to get into trouble using some Postgres features
slug: how-to-get-into-trouble-using-some-postgres-features
sidebar_label: get into trouble using some PG features
description: ""
keywords: ["postgresql","into","trouble","using","some","postgres","features","intermediate"]
tags: ["intermediate", "antipatterns", "pitfalls", "nulls", "gotchas", "troubleshooting"]
