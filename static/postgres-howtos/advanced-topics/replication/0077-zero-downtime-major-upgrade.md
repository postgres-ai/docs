---
title: Postgres major upgrade without any downtime for a very large cluster running under heavy load
slug: zero-downtime-major-upgrade
sidebar_label: PG major upgrade without any downtime for a very large cluster running under heavy load
description: ""
keywords: ["postgresql","postgres","major","upgrade","without","downtime","very","large","cluster","running","under","heavy","load","advanced"]
tags: ["advanced", "replication", "upgrade", "zero-downtime", "high-availability", "logical-replication"]
difficulty: advanced
estimated_time: 5 min
---


Some time ago (Jan 2024), on HackerNews, an article by knock.app was discussed,  
...
replica is created based on it (`copy_data = true` when creating logical subscription). However, this way of logical
replica provisioning takes a lot of time and can be very problematic to execute under heavy load.
...
As already mentioned, there are many aspects to address. You can find details in the talk – slide deck and video published [here](https://postgresql.eu/events/pgconfeu2023/schedule/session/4791-how-we-execute-postgresql-major-upgrades-at-gitlab-with-zero-downtime/).
