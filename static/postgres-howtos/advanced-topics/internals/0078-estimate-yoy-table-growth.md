---
title: How to estimate the YoY growth of a very large table using row creation timestamps and the planner statistics
slug: estimate-yoy-table-growth
sidebar_label: estimate the YoY growth of a very large table using row creation timestamps and the planner statistics
description: ""
keywords: ["postgresql","estimate","growth","very","large","table","using","creation","timestamps","planner","statistics","intermediate"]
tags: ["intermediate", "statistics", "growth-estimation", "timestamps", "planning", "analysis"]
