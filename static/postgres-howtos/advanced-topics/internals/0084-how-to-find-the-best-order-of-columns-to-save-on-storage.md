---
title: "How to find the best order of columns to save on storage (\"Column Tetris\")"
slug: how-to-find-the-best-order-of-columns-to-save-on-storage
sidebar_label: "find the best order of columns to save on storage (\"Column Tetris\")"
description: ""
keywords: ["postgresql","find","best","order","columns","save","storage","(\"column","tetris\")","intermediate"]
tags: ["intermediate", "storage", "optimization", "schema-design", "alignment", "column-order"]
