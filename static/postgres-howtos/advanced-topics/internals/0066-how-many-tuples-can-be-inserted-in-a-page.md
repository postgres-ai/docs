---
title: How many tuples can be inserted in a page
slug: how-many-tuples-can-be-inserted-in-a-page
sidebar_label: How many tuples can be inserted in a page
description: ""
keywords: ["postgresql","many","tuples","inserted","page","intermediate"]
tags: ["intermediate", "internals", "tuples", "pages", "storage", "ctid"]
...
"point" to get its first component (the page number).
