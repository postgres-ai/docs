...
As already mentioned, for the first 5 executions, it uses custom plans. Looking inside [`GetCachedPlan`](https://github.com/postgres/postgres/blob/a6598aac5295fcb169bd251cbc9fe125fa019a2d/src/backend/utils/cache/plancache.c#L1280), we see the sequence of steps:

1. [Acquire planner locks](https://github.com/postgres/postgres/blob/a6598aac5295fcb169bd251cbc9fe125fa019a2d/src/backend/utils/cache/plancache.c#L726):
    ```c
...
2. [Decide plan type](https://github.com/postgres/postgres/blob/a6598aac5295fcb169bd251cbc9fe125fa019a2d/src/backend/utils/cache/plancache.c#L1186-L1187):
    ```c
    /* Generate custom plans until we have done at least 5 (arbitrary) */
    if (plansource->num_custom_plans < 5)
        return true;  // Use custom plan
    ```
3. [Build custom plan](https://github.com/postgres/postgres/blob/a6598aac5295fcb169bd251cbc9fe125fa019a2d/src/backend/utils/cache/plancache.c#L1356):
    ```c
...
2. Decide plan type – now it's [different](https://github.com/postgres/postgres/blob/a6598aac5295fcb169bd251cbc9fe125fa019a2d/src/backend/utils/cache/plancache.c#L1201), for default `plan_cache_mode` (`auto`), the switch to generic plan happens:
    ```c
	/*
...
3. [Check for cached plan](https://github.com/postgres/postgres/blob/a6598aac5295fcb169bd251cbc9fe125fa019a2d/src/backend/utils/cache/plancache.c#L1302)
    ```c
    if (CheckCachedPlan(plansource))  // Returns FALSE - no plan yet
    ```
4. [Build generic plan](https://github.com/postgres/postgres/blob/a6598aac5295fcb169bd251cbc9fe125fa019a2d/src/backend/utils/cache/plancache.c#L1311):
    ```c
...
3. [Check for cached plan](https://github.com/postgres/postgres/blob/a6598aac5295fcb169bd251cbc9fe125fa019a2d/src/backend/utils/cache/plancache.c#L1302-L1305):
    ```c
