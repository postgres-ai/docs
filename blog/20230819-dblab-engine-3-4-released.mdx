...
<p align="center">
  <img
    src="/assets/thumbnails/dblab-3.4-blog-upd.png"
    alt="DBLab Engine 3.4: new name, SE installer, and lots of improvements"
    width="825px"
    height="515px"
    loading="eager"
  />
...
- `skipPolicie`s` in subsection `logicalRestore` to allow to skip policies (`CREATE POLICY`) during restore process.
