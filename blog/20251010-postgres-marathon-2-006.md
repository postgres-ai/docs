...
803 non-fast-path locks successfully acquired! When expected maximum for these settings was as low as ~40.
...
- A single backend can acquire far more locks than the formula suggests (>800 vs expected ~40!)
