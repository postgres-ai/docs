...
<p align="center">
    <img src="/assets/thumbnails/dle-2.5-blog.png" alt="DLE 2.5: Better data extraction for logical mode and configuration improvements"/>
</p>

:::note
Action required to migrate from a previous version. See [Migration notes](#migration-notes).
:::
