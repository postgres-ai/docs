...
Application DBA – a database engineer responsible for tasks such as DB schema design, development and deployment of changes, query performance optimization, and so on, while "Infrastructure DBA" is responsible for database provisioning, replication, backups, global configuration. The term "Application DBA" was introduced by [@be_haki](https://twitter.com/be_haki) in ["Some SQL Tricks of an Application DBA"](https://hakibenita.medium.com/some-sql-tricks-of-an-application-dba-3145001d999f).
