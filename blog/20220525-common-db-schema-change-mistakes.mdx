...
<p align="center">
  <img
    src="/assets/thumbnails/20220525-common-db-schema-change-mistakes2.jpg"
    alt="Stepping on a 'rake db:migrate'"
    width="825px"
    height="380px"
    loading="eager"
  />
...
- [Case 7. Waiting to acquire an exclusive lock for long ⇒ blocking others)](#case-7-waiting-to-acquire-an-exclusive-lock-for-long--blocking-others)
