...
authors:
  - name: Nikolay Samokhvalov
    title: Postgres.AI Founder
    url: https://linkedin.com/in/samokhvalov
    socials:
      x: samokhvalov
      github: NikolayS
      gitlab: NikolayS
  - name: Vitaliy Kukharik
    title: Postgres DBA
    socials:
      x: vkukharik
      github: vitabaks
...
publishDate: 2024-10-03 13:21:12
...
In this post, I'm using our [Postgres.AI assistant](https://postgres.ai/blog/20240127-postgres-ai-bot) to see how planning time depends on the number of partitions.
...
*Acknowledgments: We thank the people who participated in preparing the data for this blog post, reviewing it, iterating, and fixing: Dmitry Fomin, Bogdan Tsechoev, Tatiana Samokhvalova, and Andrei Lepikhov.*
