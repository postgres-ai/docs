...
Today we're releasing [postgres_ai monitoring v0.7](https://gitlab.com/postgres-ai/postgres_ai), a monitoring solution built specifically for Postgres experts who need rapid root cause analysis and deep performance insights. This isn't a tool for beginners—it's designed for experienced DBAs and SREs who need to understand complex performance issues in minutes, not hours.
...
postgres_ai v0.7 is designed for:
