...
_This article was originally published [in 2018](https://medium.com/@samokhvalov/how-partial-indexes-affect-update-performance-in-postgres-d05e0052abc). This is a reviewed and extended version of it. The discussed findings can be applied to any actual major version of PostgreSQL._
...
- If we consider the SELECT query with additional filter `... and price is not null`), then it is reasonable to assume that making the index _partial_ should improve the index scan speed: `create index ... where price is not null`. Worth checking it.
...
"HOT" stands for _Heap Only Tuples_, this is an internal technique of how PostgreSQL may perform an UPDATE of a tuple. It's not well documented in the main PostgreSQL documentation, but here is a few tips helpful for those who are interested to learn about it:
...
<p align="center">
  <a
    href="/assets/blog/20211029-partial_and_covering_indexes_and_hot_updates_summary.png"
    target="blank"
  >
    <img
      src="/assets/blog/20211029-partial_and_covering_indexes_and_hot_updates_summary.png"
      alt="Summary: partial, covering, and multi-column index vs. HOT updates in PostgreSQL"
    />
  </a>
</p>
