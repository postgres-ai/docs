const careers = [
  {
    ...
    description: '- Strong optimization skills of large and heavily loaded databases (>1TiB, >10k QpS).' +
  ...
  },
  {
    ...
    description: '- 3+ years experience developing server applications using Go.' +
