    ...
    <div className={styles.tableContainer} id="aws-pricing-details">
      ...
      <table className={styles.table}>
        ...
        {tableData.map((item, index) => (
          <tr key={index}>
            ...
            <td>{item.ram_gib}</td>
            <td>
              {item.native_reference_price_currency}{item.dle_se_price_hourly}
            </td>
            <td>
      ...
      <div className={styles.notes}>
        ...
        <ul>
          ...
          <li>
            You can use your own hardware (hello, cloud repatriates).
            Select the "BYOM" ("Bring Your Own Machine") option when setting up
            DBLab SE. This also lets you install DBLab SE on a VM in any cloud.
          </li>
          <li>
            ...
            </a>. Costs for cloud resources like VM, storage, network, dedicated
            IP addresses are not part of DBLab SE pricing. You will pay them
            directly to your cloud provider.
          </li>
          <li>
            The price of DBLab SE is based on the "compute" capacity of your machine.
            If the CPU count and RAM size are not an exact match, the closest
            available option is automatically used.
          </li>
          <li>
            DBLab SE pricing is not based on the database size. However, there is
            a current size limit of 2000 GiB for database size of a single DBLab SE
            instance. If you need more, please{' '}
          ...
          <li>
            To stop charges, just de-provision your DBLab SE instance.
            The hour you shut it down will be considered the final hour for billing.
          </li>
          <li>
