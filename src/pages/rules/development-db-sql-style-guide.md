---
title: Development Db Sql Style Guide
description: PostgresAI rule - Development Db Sql Style Guide
---

---
alwaysApply: true
description: "SQL style guide for consistent formatting and naming conventions"
globs: "*.sql,*.psql,*.md"
---
...
## Table design rules
- Always add `id` column of type `int8 generated always as identity`
- Always add table comments using `comment on table...`
- Default to `public` schema
- Include schema in queries for clarity
- Use plural table names (`users`, `blog_posts`) with `_id` suffix for foreign keys
